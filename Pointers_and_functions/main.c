...
// In this tutorial, you'll learn to pass addresses and pointers as arguments to 
...
// When *n1 and *n2 are changed inside the swap() function, num1 and 
// num2 inside the main() function are also changed.
