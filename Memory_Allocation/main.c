...
// In this tutorial, you'll learn to dynamically allocate memory in your C program 
...
// To allocate memory dynamically, library functions are malloc(), calloc(), realloc() a
// nd free() are used. These functions are defined in the <stdlib.h> header file.
...
// float is 4 bytes. And, the pointer ptr holds the address of the first byte in the allocated memory.
