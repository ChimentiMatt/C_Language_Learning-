...
// In this tutorial, you'll learn about the relationship between arrays and pointers 
// in C programming. You will also learn to access array elements using pointers.
...
// That's the reason why you can use pointers to access elements of arrays. However, you should 
